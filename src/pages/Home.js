...
function Home(props) {
    ...
    return (
        <>
            ...
            {/*    <div className="top-user flex-shrink-0 px-4 py-3 bg-gray-800">*/}
            ...
            {/*                <path d="M16 10l-4 4-4-4" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"></path>*/}
            {/*            </svg>*/}
            {/*        </button>*/}
            {/*    </div>*/}
                    ...
                    <div className="main-content">
                        <div className="content-wrapper">
                            <div className="email-application">
                                ...
                                <div id="sidebar" className="p-5_ bg-gray-100 text-gray-900 email-app-sidebar float-left d-none d-xl-block d-flex_ flex-column flex-shrink-0  text-white bg-dark">
                                ...
                                <div className="email-app-content _row">
                                    ...
                                    <div className="email-app-content-area w-100">
                                        ...
                                        <div className="email-app-mail-content bg-white">
                                            <div className="email-app-mail-content-detail p-6">
                                                <div className="email-app-options card__body">
                                                    <div className="ro_w d-md-none">
                                                        ...
                                                        {/*</button>*/}
                                                        <button className="my-3 ml-2 back-to-inbox bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded">
                                                            Back
                                                        </button>
                                                    </div>
                                                </div>
